                ...
                <nav class="nav">
                    <form action="" method="post">
                        <ul class="header__menu">
                            ...
                            <li class="menu__item"><a href="daka.php" class="menu__item--link">Daka</a></li>
                            <li class="menu__item"><a href="multimaxmcbo.php" class="menu__item--link">Multimax Mcbo</a></li>
                ...
                <table class="table" id="table">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>LINEA</th>
                            <th>REGION</th>
                            <th>MULTIMAX LIMPIA</th>
                            
                        </tr>
                    </thead>

                    <?php
                    include("../php/Querys/comerciales/multimaxlimpia.php");
                    ?>
                </table>
